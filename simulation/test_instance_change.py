...
from sim_event_stream import ErrorEvent, sim_event_stream, sim_events, ListEventStream
...
def pool_model_events(draw, node_count):
    ...
    input_events = st.one_of(outage_event(max_count=1, min_id=1, max_id=node_count),
                             outage_event(max_count=node_count // 2, min_id=1, max_id=node_count),
