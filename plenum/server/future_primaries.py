...
class FuturePrimaries:
    ...
    def __init__(self, node, ):
        ...
        self.future_node_reg = []

        # Nodes are never delete from here, so they are in a sequential order
        self.future_ordered_node_ids = dict()

        self.future_required_number_of_instances = 0
    ...
    def set_future_pool(self, node_reg, ordered_node_ids, current_required, primaries):
        ...
        # future_primaries's fields like in node
        self.future_node_reg = list(node_reg.keys())
        self.future_ordered_node_ids = copy.deepcopy(ordered_node_ids)
