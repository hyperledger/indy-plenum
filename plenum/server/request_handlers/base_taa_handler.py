...
class BaseTAAHandler(WriteRequestHandler, metaclass=ABCMeta):
    ...
    def _update_txn_author_agreement(self, digest, seq_no, txn_time, text=None, version=None,
                                     retired=None, ratified=None):
        ...
        if ledger_data and ledger_data[0]:
            ...
            ratified = ledger_taa.get(TXN_AUTHOR_AGREEMENT_RATIFICATION_TS, last_update_time)
