...
class Replica(HasActionQueue, MessageProcessor, HookManager):
    ...
    def _mark_requests_reset(self, req_keys: Iterable[Tuple[int, int]]):
        self.logger.debug("{} setting requests as reset: {}".format(self, req_keys))
        for key in req_keys:
    ...
    def _mark_requests_ordered(self, req_keys: Iterable[Tuple[int, int]]):
        self.logger.debug("{} setting requests as ordered: {}".format(self, req_keys))
        for key in req_keys:
    ...
    def _mark_requests_reverted(self, req_keys: Iterable[Tuple[int, int]]):
        self.logger.debug("{} setting requests as reverted: {}".format(self, req_keys))
        for key in req_keys:
    ...
    def _mark_requests_cleaned(self, req_keys: Iterable[Tuple[int, int]]):
        self.logger.debug("{} setting requests as cleaned: {}".format(self, req_keys))
        for key in req_keys:
    ...
    def revert(self, ledgerId, stateRootHash, req_keys: Iterable[Tuple]):
        ...
        self.logger.debug(
            "{} reverting {} txns and state root from {} to {} for ledger {}"
            .format(self, len(req_keys),
                    state.headHash, stateRootHash, ledgerId))
