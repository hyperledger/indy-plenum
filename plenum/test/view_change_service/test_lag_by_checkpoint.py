...
from plenum.test.helper import vdr_send_random_and_check, checkViewNoForNodes, assertExp, get_pp_seq_no
...
def test_lag_less_then_catchup(looper,
    ...
    with delay_rules_without_processing(delayed_node.nodeIbStasher, cDelay()):
        ...
        vdr_send_random_and_check(looper, txnPoolNodeSet, vdr_pool_handle, vdr_wallet_client, CHK_FREQ)
    ...
    vdr_send_random_and_check(looper, txnPoolNodeSet, vdr_pool_handle, vdr_wallet_client, CHK_FREQ - 1)
