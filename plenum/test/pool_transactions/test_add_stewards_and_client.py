...
from plenum.test.pool_transactions.helper import prepare_new_node_data, vdr_prepare_node_request, \
    vdr_sign_and_send_prepared_request
from stp_core.loop.eventually import eventually


def testAddNewClient(looper, txnPoolNodeSet, vdr_wallet_new_client):
    _, did = vdr_wallet_new_client
...
def testStewardCannotAddNodeWithNonBase58VerKey(looper, tdir, tconf,
    ...
    _, steward_did = vdr_wallet_new_steward
