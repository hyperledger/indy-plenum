...
def test_load_regs_on_catchup_finished_view_1(node_reg_handler, init_node_reg_handler,
                                              write_req_manager,
                                              add_node_reg_to_audit):
    add_node(write_req_manager, "Epsilon", 1, 1, commit=True, add_node_reg_to_audit=add_node_reg_to_audit)
    demote_node(write_req_manager, "Alpha", 2, 1, commit=True, add_node_reg_to_audit=add_node_reg_to_audit)
...
def test_load_regs_on_catchup_finished_views_0_1(node_reg_handler, init_node_reg_handler,
                                                 write_req_manager,
                                                 add_node_reg_to_audit):
...
@pytest.mark.parametrize('add_node_reg_to_audit', ['True', 'False', 'Latest_only'])
def test_load_regs_on_catchup_finished_views_0_1_2(node_reg_handler, init_node_reg_handler,
                                                   write_req_manager,
                                                   add_node_reg_to_audit):
    add_node_reg_to_audit_view_0 = add_node_reg_to_audit == 'True'
