...
from plenum.test.helper import max_3pc_batch_limits, sdk_send_random_requests
...
def check_prepared(nodes):
    ...
    assert pre_prepared_txns == pre_prepared_txns
...
def test_preprepares_and_prepares_recovery_after_catchup(tdir, tconf,
    ...
    sdk_send_random_requests(looper, sdk_pool_handle, sdk_wallet_client, NUM_OF_REQ)
