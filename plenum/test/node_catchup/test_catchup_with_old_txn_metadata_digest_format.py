...
def test_catchup_with_old_txn_metadata_digest_format(tdir, tconf,
    ...
    def append_old_payload_metadata(txn, frm=None, req_id=None, digest=None, payload_digest=None, taa=None):
        txn = append_payload_metadata(txn, frm, req_id, digest, payload_digest, taa)
