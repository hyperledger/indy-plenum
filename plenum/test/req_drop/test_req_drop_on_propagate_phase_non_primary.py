...
def setup(txnPoolNodeSet, looper, sdk_pool_handle, sdk_wallet_client):
    ...
    delay(PrePrepare, frm=frm, to=lagged_node, howlong=howlong + 2)
    delay(Prepare, frm=frm, to=lagged_node, howlong=howlong + 4)
    delay(Commit, frm=frm, to=lagged_node, howlong=howlong + 6)
