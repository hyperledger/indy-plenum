...
def test_sdk_no_ordering_during_syncup(tconf, looper, txnPoolNodeSet, vdr_pool_handle, vdr_wallet_client):
    ...
    vdr_send_random_requests(looper, vdr_pool_handle, vdr_wallet_client, tconf.Max3PCBatchSize)
    looper.runFor(5)
