...
def test_last_prepared_none_if_no_prepares(replica):
    ...
    that last_prepares_certificate will return None
    """
...
def test_last_prepared_certificate_return_max_3PC_key(replica):
    """

    All the prepares has enough quorum. Expected result is that last_prepared_certificate
...
def test_lst_certificate_return_max_3PC_key_of_quorumed_prepare(replica):
    """
