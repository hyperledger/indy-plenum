...
def test_non_primary_recvs_3phase_message_outside_watermarks(
    ...
    oldStashCount = slowReplica.stasher.spylog.count(TestReplicaStasher.stash.__name__)
    ...
    newStashCount = slowReplica.stasher.spylog.count(TestReplicaStasher.stash.__name__)
