...
def testCheckpointCreated(chkFreqPatched, looper, txnPoolNodeSet, client1,
    ...
    """
    sendReqsToNodesAndVerifySuffReplies(looper, wallet1, client1, chkFreqPatched.CHK_FREQ-1, 1)
...
def testOldCheckpointDeleted(chkFreqPatched, looper, txnPoolNodeSet, client1,
    ...
    """
    sendReqsToNodesAndVerifySuffReplies(looper, wallet1, client1, 2*chkFreqPatched.CHK_FREQ,
                                        1)
