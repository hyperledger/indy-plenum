...
def test_view_change_in_between_3pc_2_of_4_nodes_with_non_primary(txnPoolNodeSet, looper,
                                                 wallet1, client):
    """
    ...
    view_change_in_between_3pc(looper, txnPoolNodeSet, slow_nodes, wallet1, client)
...
def test_view_change_in_between_3pc_2_of_4_nodes_with_old_primary(txnPoolNodeSet, looper,
    ...
    """
    - Slow processing 3PC messages for 2 of 4 node (2>f)
    - Slow the current Primary node and the last non-primary node (it will not be the next primary because of round-robin).
    - do view change
    """
...
def test_view_change_in_between_3pc_2_of_4_nodes_with_new_primary(txnPoolNodeSet, looper,
                                                 wallet1, client):
    """
    - Slow processing 3PC messages for 2 of 4 node (2>f)
    - Slow the the first and the last non-primary node
     (the first will be primary and the last one will not be the next primary because of round-robin).
    - do view change
    """
...
def test_view_change_in_between_3pc_2_of_4_nodes_with_old_and_new_primary(txnPoolNodeSet, looper,
                                                 wallet1, client1, client):
    """
    - Slow processing 3PC messages for 2 of 4 node (2>f)
...
def test_view_change_in_between_3pc_all_nodes(txnPoolNodeSet, looper,
    ...
    - do view change
    """
    view_change_in_between_3pc(looper, txnPoolNodeSet, txnPoolNodeSet, wallet1, client)


def test_view_change_in_between_3pc_all_nodes_random_delays(txnPoolNodeSet, looper,
                                              wallet1, client):
    """
    - Slow processing 3PC messages for all nodes randomly
    - do view change
    """
    view_change_in_between_3pc_random_delays(looper, txnPoolNodeSet, txnPoolNodeSet, wallet1, client)