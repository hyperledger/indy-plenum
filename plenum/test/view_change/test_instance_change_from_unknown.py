def test_instance_change_from_known(fake_view_changer):
    ...
    fake_view_changer.process_instance_change_msg(ic_msg,
                                                  frm=frm)
    assert fake_view_changer.instance_change_provider.has_inst_chng_from(proposed_view, frm)
...
def test_instance_change_from_unknown(fake_view_changer):
    ...
    fake_view_changer.process_instance_change_msg(ic_msg,
                                                  frm=frm)
    assert not fake_view_changer.instance_change_provider.has_inst_chng_from(proposed_view, frm)
