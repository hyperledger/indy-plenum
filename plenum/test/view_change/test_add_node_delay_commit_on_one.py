...
def test_add_node_delay_commit_on_one(looper, txnPoolNodeSet, vdr_pool_handle,
    ...
    with delay_rules(txnPoolNodeSet[-1].nodeIbStasher, cDelay()):
        _, new_node = vdr_add_new_steward_and_node(looper, vdr_pool_handle, vdr_wallet_steward,
                                                   'New_Steward', 'Epsilon',
