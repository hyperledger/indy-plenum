...
from plenum.test.helper import vdr_send_random_and_check, vdr_send_random_requests, vdr_get_replies, send_pre_prepare, \
...
def test_old_view_requests_processed_during_view_change(looper, txnPoolNodeSet,
    ...
    requests = vdr_send_random_requests(looper, sdk_wallet_handle,
                                        sdk_wallet_client, 2)
    looper.runFor(1)
