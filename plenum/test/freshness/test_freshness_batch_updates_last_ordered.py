...
def test_freshness_batch_updates_last_ordered(looper, txnPoolNodeSet, sdk_pool_handle,
    ...
    assert txnPoolNodeSet[0].master_replica.node.db_manager.get_txn_root_hash(DOMAIN_LEDGER_ID) == \
           txnPoolNodeSet[1].master_replica.node.db_manager.get_txn_root_hash(DOMAIN_LEDGER_ID)
