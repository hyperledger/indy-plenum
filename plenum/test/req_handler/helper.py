...
from plenum.common.constants import ROLE, TXN_TYPE, NYM, TARGET_NYM, TXN_AUTHOR_AGREEMENT_TEXT, \
    TXN_AUTHOR_AGREEMENT_VERSION, TXN_AUTHOR_AGREEMENT_RETIRED, TXN_AUTHOR_AGREEMENT_DIGEST, \
...
def create_taa_txn(taa_request):
    ...
    state_value[TXN_AUTHOR_AGREEMENT_RATIFIED] = None if retired else taa_txn_time
