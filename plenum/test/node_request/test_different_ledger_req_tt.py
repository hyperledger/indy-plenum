...
from plenum.test.helper import sendReqsToNodesAndVerifySuffReplies, \
    sendRandomRequests, waitForSufficientRepliesForRequests, sdk_send_random_and_check, sdk_send_random_requests, \
    sdk_json_couples_to_request_list
...
def test_different_ledger_request_interleave(tconf, looper, txnPoolNodeSet,
    ...
    requests = sdk_json_couples_to_request_list(
    ...
    requests.extend(sdk_json_couples_to_request_list(
        sdk_send_random_requests(looper, sdk_pool_handle, sdk_wallet_client, 3)))
