...
def nodeSetWithTaa(set_txn_author_agreement_aml, txnPoolNodeSet, looper, sdk_pool_handle, sdk_wallet_trustee):
...
def test_get_txn_author_agreement_works_on_clear_state(looper, set_txn_author_agreement_aml, txnPoolNodeSet, sdk_pool_handle,
                                                       sdk_wallet_client):
...
def test_get_txn_author_agreement_can_return_taa_for_old_digest(looper, set_txn_author_agreement_aml, nodeSetWithTaa,
                                                                sdk_pool_handle, sdk_wallet_client):
    reply = sdk_get_txn_author_agreement(looper, sdk_pool_handle, sdk_wallet_client,
                                         digest=DIGEST_V1)[1]
    assert reply['op'] == REPLY
...
def test_get_txn_author_agreement_can_return_taa_for_current_digest(looper, set_txn_author_agreement_aml, nodeSetWithTaa,
                                                                    sdk_pool_handle, sdk_wallet_client):
    reply = sdk_get_txn_author_agreement(looper, sdk_pool_handle, sdk_wallet_client,
                                         digest=DIGEST_V2)[1]
    assert reply['op'] == REPLY
...
def test_get_txn_author_agreement_doesnt_return_taa_for_nonexistent_digest(looper, set_txn_author_agreement_aml, nodeSetWithTaa,
                                                                           sdk_pool_handle, sdk_wallet_client):
    reply = sdk_get_txn_author_agreement(looper, sdk_pool_handle, sdk_wallet_client,
