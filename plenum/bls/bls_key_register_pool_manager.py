...
from plenum.common.constants import BLS_KEY, BLS_KEY_PROOF, ALIAS, POOL_LEDGER_ID
...
class BlsKeyRegisterPoolManager(BlsKeyRegister):
    ...
    def get_pool_root_hash_committed(self):
        return self._node.getState(POOL_LEDGER_ID).committedHeadHash
    ...
    def _load_keys_for_root(self, pool_state_root_hash):
        ...
        for data in self._node.get_req_handler(POOL_LEDGER_ID).get_all_node_data_for_root_hash(
