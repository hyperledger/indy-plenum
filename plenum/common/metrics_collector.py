...
class MetricsName(IntEnum):
    ...
    PRIMARY_DECIDER_REPEATIN_ACTIONS = 30018
    ...
    REPLICA_CHECKPOINTS_MASTER = 31015
    REPLICA_STASHED_RECVD_CHECKPOINTS_MASTER = 31016
    REPLICA_STASHING_WHILE_OUTSIDE_WATERMARKS_MASTER = 31017
    REPLICA_REQUEST_QUEUES_MASTER = 31018
    REPLICA_BATCHES_MASTER = 31019
    REPLICA_REQUESTED_PRE_PREPARES_MASTER = 31020
    REPLICA_REQUESTED_PREPARES_MASTER = 31021
    REPLICA_REQUESTED_COMMITS_MASTER = 31022
    REPLICA_PRE_PREPARES_STASHED_FOR_INCORRECT_TIME_MASTER = 31023

    REPLICA_ACTION_QUEUE_MASTER = 31024
    REPLICA_AQ_STASH_MASTER = 31025
    REPLICA_REPEATING_ACTIONS_MASTER = 31026
    REPLICA_SCHEDULED_MASTER = 31027
    ...
    REPLICA_CHECKPOINTS_BACKUP = 32015
    REPLICA_STASHED_RECVD_CHECKPOINTS_BACKUP = 32016
    REPLICA_STASHING_WHILE_OUTSIDE_WATERMARKS_BACKUP = 32017
    REPLICA_REQUEST_QUEUES_BACKUP = 32018
    REPLICA_BATCHES_BACKUP = 32019
    REPLICA_REQUESTED_PRE_PREPARES_BACKUP = 32020
    REPLICA_REQUESTED_PREPARES_BACKUP = 32021
    REPLICA_REQUESTED_COMMITS_BACKUP = 32022
    REPLICA_PRE_PREPARES_STASHED_FOR_INCORRECT_TIME_BACKUP = 32023

    REPLICA_ACTION_QUEUE_BACKUP = 32024
    REPLICA_AQ_STASH_BACKUP = 32025
    REPLICA_REPEATING_ACTIONS_BACKUP = 32026
    REPLICA_SCHEDULED_BACKUP = 32027
