...
class Router:
    ...
    def __init__(self):
        self.__handlers = defaultdict(list)  # type: Dict[Type, List[Callable]]
    ...
    def message_types(self) -> List[Type]:
        ...
        """
        return [message_type
                for message_type, handlers in self.__handlers.items()
                if len(handlers) > 0]
    ...
    def handlers(self, message_type: Type) -> List[Callable]:
        ...
        """
        return self.__handlers.get(message_type, [])
    ...
    def unsubscribe(self, sid: SubscriptionID):
        ...
        """
        self.__handlers[sid[0]].remove(sid[1])
    ...
    def _route(self, message: Any, *args) -> List:
        ...
        """
        handlers = self.__handlers[type(message)]
