...
options.skip([StagesEnum.GITHUB_RELEASE, StagesEnum.TEST])
options.setPublishableBranches(['simple-election']) //REMOVE IT BEFORE MERGE
options.setPostfixes([master: 'simple-election']) //REMOVE IT BEFORE MERGE
